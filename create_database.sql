...
CREATE TABLE users(username varchar(20), password varchar(20), role varchar(20), balance int, PRIMARY KEY (username));
...
INSERT INTO users(username, password, role, balance) VALUES ('admin', 'admin', 'admin', 0)